...
import NewTournamentMatchPage from "./pages/NewTournamentMatchPage.jsx";
import AssignScorerPage from "./pages/AssignScorerPage.jsx";
import EditMatchPage from "./pages/EditMatchPage.jsx";
import EditTournamentPage from "./pages/EditTournamentPage.jsx";
import ScorerAssignmentsPage from "./pages/ScorerAssignmentsPage.jsx";
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 pb-16 md:pb-0">
        ...
        <Routes>
          ...
          />
          <Route
            path="/dashboard/tournaments/:id/new-match"
            element={
              <RequireAuth>
                <NewTournamentMatchPage />
              </RequireAuth>
            }
          />
          <Route
          ...
          />
          <Route
            path="/dashboard/matches/:id/edit"
            element={
              <RequireAuth>
                <EditMatchPage />
              </RequireAuth>
